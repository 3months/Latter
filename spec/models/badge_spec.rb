...
describe Badge, type: :model do
  ...
  it "should be able to be awarded and verified as awarded_to? in the model" do
    subject.save
    subject.awarded_to?(@player1).should be false
    @player1.award!(subject)
    subject.awarded_to?(@player1).should be true
  end
  ...
  it "should qualify correctly a badge for condition with no numeric component" do
    ...
    subject.qualifies?(@player1).should be true
  end
  ...
  it "should qualify correctly a badge for greater than n condition" do
    ...
    subject.qualifies?(@player1).should be false
  end
  ...
  it "should set the award date correctly if specified" do
    ...
    subject.awarded_to?(@player1).should be true
    (subject.awards.where(:player_id => @player1.id).first.award_date < 6.days.ago).should be true
  end
